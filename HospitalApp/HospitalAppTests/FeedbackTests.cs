...
namespace HospitalAppTests
{
    public class FeedbackTests
    {
        ...
        {
            FeedbackController controller = new FeedbackController(SetupRepository(null).Object);
        ...
        public void Get_by_id()
        {
            ...
            FeedbackController controller = new FeedbackController(SetupRepository(myFeedback).Object);
        ...
        public void Add_feedback()
        {
            ...
            FeedbackController controller = new FeedbackController(SetupRepository(feedback).Object);
