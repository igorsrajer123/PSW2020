    ...
    public class AppointmentServiceTests
    {
        ...
        public void Get_all_appointments()
        {
            using (var context = new MyDbContext(_options))
            {
                ...
                ReferralService referralService = new ReferralService(context);
                AppointmentService service = new AppointmentService(context, referralService);
        ...
        {
            List<Appointment> apps = apps = new List<Appointment>();
