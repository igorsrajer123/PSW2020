...
namespace HospitalAppTests
{
    public class DoctorTests
    {
        ...
        {
            DoctorController controller = new DoctorController(SetupRepository(null, null).Object);
        ...
        public void Get_by_id()
        {
            ...
            DoctorController controller = new DoctorController(SetupRepository(myDoctor, null).Object);
        ...
        public void Get_by_type()
        {
            ...
            DoctorController controller = new DoctorController(SetupRepository(null, specialists).Object);
        ...
        public void Get_general_practitioner()
        {
            ...
            DoctorController controller = new DoctorController(SetupRepository(doctor, null).Object);
